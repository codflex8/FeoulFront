...
import { Project } from "@/app/[locale]/dashboard/projects/page";
import { Operation } from "@/app/[locale]/dashboard/financial/page";
import { Unit } from "@/app/[locale]/dashboard/booked-buildings/page";
import { Category } from "@/app/[locale]/dashboard/categories/page";
...
export const projectsColumns: ColumnDef<Project>[] = [
  ...
  },
  {
    ...
    // cell: ({ row }) => <p className="text-center font-medium text-sm">{row.getValue("status")}</p>,
  ...
  {
    accessorKey: "modelAdded",
    header: () => <div className="text-center font-semibold">إضافة نموذج المشروع</div>,
    cell: ({ row }) => <p className="text-center font-medium text-sm">{row.getValue("modelAdded")}</p>,
  },
  {
    id: "actions",
    header: () => <div className="text-center font-semibold">الإجراءات</div>,
